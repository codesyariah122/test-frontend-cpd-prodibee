<template>
	<div v-if="$device.isDesktop">
		<LayoutsNavbarAuthDesktop :token="token" :profiles="profiles" :slug="slug" @logout-profile="LogoutProfile" :event_id="event_id" :event_path="event_path"/>
	</div>
	<div v-else>
		<LayoutsNavbarAuthMobile :token="token" :profiles="profiles" :slug="slug" @logout-profile="LogoutProfile" :event_id="event_id" :event_path="event_path"/>
	</div>
</template>
