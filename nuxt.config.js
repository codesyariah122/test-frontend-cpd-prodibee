...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      {
        hid: "description",
        name: "description",
        content: "CPD Online Perawat | CPD Online - Website",
      },
  ...
  pwa: {
    meta: {
      title: "CPD Online Perawat",
      author: "CPD",
      icon: true,
      canonical: "https://ppkc-online.com/",
      description: "CPD Online Perawat | CPD Online - Website",
      keywords: "CPDOnline",
      ogUrl: "https://cpd.halomedika.com/",
      ogType: "website",
      ogSiteName: "CPD Online Perawat",
      ogTitle: "CPD Online Perawat",
    ...
    manifest: {
      lang: "en",
      name: "CPD Online Perawat",
      short_name: "CPDOnline",
      description: "CPD Online Perawat",
      start_url: "/",
      lang: "en",
      display: "standalone",
      theme_color: "#2f80ed",
